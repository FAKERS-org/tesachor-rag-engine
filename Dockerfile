## --- Production Dockerfile for FastAPI with UV and Python 3.14
...
## Development Dockerfile for FastAPI with UV and Python 3.14
...
# # Create volume mount point for vector DB
